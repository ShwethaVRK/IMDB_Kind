...
using System.Linq;
using Shwetha.EF.ShwethaDB;
using Shwetha.EF.LoggingService;
using Shwetha.Models;

namespace Shwetha.EF.ShwethaService
{
    public class ShwethaService : IShwethaService
    {
        ...
        public List<MoviesViewModel> GetListOfMovies()
        {
            ...
            catch (Exception exception)
            {
                ...
                ErrorLogService.WriteError(exception, "GetListOfMovies", "ShwethaService");
                throw;
            }
        }
        ...
        public MoviesViewModel GetMovieDetailsById(int id)
        {
            ...
            {
                // Here, we can use a errorlog table to save the error with all its path details
                ErrorLogService.WriteError(ex, "GetListOfMovies", "ShwethaService");
                throw;
            }
        }
